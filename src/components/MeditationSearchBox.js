    ...
    <ChillfulSearchBoxFrame>
      <ChillfulSearchBox>
        <ChillfulSearchBoxInner>
          <div>
            <ChillfulSearchBoxBtn>Wake Up</ChillfulSearchBoxBtn>
            <ChillfulSearchBoxBtn>Travel</ChillfulSearchBoxBtn>
            <ChillfulSearchBoxBtn2>Focus</ChillfulSearchBoxBtn2>
            <ChillfulSearchBoxBtn3>Destress</ChillfulSearchBoxBtn3>
            <ChillfulSearchBoxBtn4>Live Well</ChillfulSearchBoxBtn4>
            <ChillfulSearchBoxBtn4>Sleep</ChillfulSearchBoxBtn4>
          ...
          <ChillfulSearchSearchBar>
            <ChillfulSearchTable>
              <tbody>
                <tr>
                  <td>
                    <ChillfulSearchIntro><ChillfulSearchIntroStrong>Explore</ChillfulSearchIntroStrong> and partake in our diversed picks of <ChillfulSearchIntroStrong>guided meditation...</ChillfulSearchIntroStrong></ChillfulSearchIntro>
