...
function Activity() {
  ...
  const [chillfulActivityPackages, setChillfulActivityPackages] = useState([]);
  ...
  useEffect(() => {
    ...
    db.collection("chillfulActivities").doc('12DxUVuZ8qwC3xLvbv16')
      ...
      .then( doc => {
        ...
        //setChillfulActivityPackages(data['packages']);
    });
    ...
    db.collection("chillfulActivities").doc('12DxUVuZ8qwC3xLvbv16').collection('timeslots')
      ...
      .then((snapshot) => {
        snapshot.docs.forEach(doc => {
          //var a = doc.data()['datetimeFrom'];
          var a = new Date(2020, 9, 19).getTime();
          setItems([...items, {
            value: a,
          }])
        });
    ...
    $('#calendar').append('<div style="position:absolute;width:100%;height:100%;opacity:0.3;z-index:100;background:#000;"></div>');
...
/*
  const availableDates = [
    ...
    new Date(2020, 10, 19).getTime(),
    new Date(2021, 1, 2).getTime(),
  ];
  */
                    ...
                    <ActivityPackageOptionTableDivInner>
                      ...
                      <ActivityPackageOptionTableQuantity>
                        <ActivityPackageOptionTableQuantityInner>
                          ...
                          <ActivityPackageOptionTableQuantityPrice>
                            ...
                            <ActivityPackageOptionTableQuantityPriceMinus onClick={() => minus_quality("student")} id="student_quantity_minus">-</ActivityPackageOptionTableQuantityPriceMinus>
                            <ActivityPackageOptionTableQuantityPriceQuantity onClick="shoot()" defaultValue="0" id="studentQuantity"></ActivityPackageOptionTableQuantityPriceQuantity>
                            <ActivityPackageOptionTableQuantityPricePlus onClick={() => plus_quality("student")} id="student_quantity_plus">+</ActivityPackageOptionTableQuantityPricePlus>
                          </ActivityPackageOptionTableQuantityPrice>
                        </ActivityPackageOptionTableQuantityInner>
                      </ActivityPackageOptionTableQuantity>
                      ...
                      <ActivityPackageOptionTableQuantity>
                        <ActivityPackageOptionTableQuantityInner>
                          ...
                          <ActivityPackageOptionTableQuantityPrice>
                            <ActivityPackageOptionTableQuantityPriceAmount>HKD180.00</ActivityPackageOptionTableQuantityPriceAmount>
                            <ActivityPackageOptionTableQuantityPriceMinus>-</ActivityPackageOptionTableQuantityPriceMinus>
                            <ActivityPackageOptionTableQuantityPriceQuantity value="0"></ActivityPackageOptionTableQuantityPriceQuantity>
                            <ActivityPackageOptionTableQuantityPricePlus>+</ActivityPackageOptionTableQuantityPricePlus>
                          </ActivityPackageOptionTableQuantityPrice>
                        </ActivityPackageOptionTableQuantityInner>
                      </ActivityPackageOptionTableQuantity>
